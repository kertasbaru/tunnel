...
@bot.on(events.CallbackQuery(data=b'member-vme'))
async def member_vme(event):
    async def member_vme_(event):
...
async def vmess(event):
	async def vmess_(event):
		inline = [
[Button.inline("‹ MEMBER XRAY ›","member-vme")],

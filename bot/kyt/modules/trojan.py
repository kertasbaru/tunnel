...
@bot.on(events.CallbackQuery(data=b'member-tro'))
async def member_tro(event):
    async def member_tro_(event):
...
async def trojan(event):
	async def trojan_(event):
		inline = [
[Button.inline("‹ MEMBER XRAY ›","member-tro")],
